💻 This demo leverages Whisper, a multilingual speech recognition model, for real-time speech transcription, language identification, and sentiment analysis using the RoBERTa Base model.
